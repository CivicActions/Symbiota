                        ...
                        <div class="clearfix">
                          <fieldset>
                            ...
                            <div id="parentTaxonIndigenousDiv">
                              ...
                              <a href="#" onclick="return dwcDoc('parentTaxonIndigenous')"><img class="docimg" src="../../images/qmark.png" /></a><br/>
                              <textarea name="parenttaxonindigenous" id="parentTaxonIndigenous" tabindex="133" onchange="fieldChanged('parenttaxonindigenous');" style="height:40px;resize:vertical;" ><?php echo array_key_exists('parenttaxonindigenous',$occArr)?$occArr['parenttaxonindigenous']:''; ?></textarea>
															<?php
															if(!isset($PARENTTAXONINDIGENOUSLABEL) || $PARENTTAXONINDIGENOUSLABEL){
																echo '<a href="#" onclick="openParentSppAid();return false;"><img src="../../images/list.png" /></a>';
															}
															?>
														</div>
                            <div id="siblingTaxaIndigenousDiv">
                              <?php echo (defined('SIBLINGTAXAINDIGENOUSLABEL')?SIBLINGTAXAINDIGENOUSLABEL:'Sibling taxa'); ?>
                              <a href="#" onclick="return dwcDoc('siblingTaxaIndigenous')"><img class="docimg" src="../../images/qmark.png" /></a><br/>
                              <textarea name="siblingtaxaindigenous" id="siblingTaxaIndigenous" tabindex="134" onchange="fieldChanged('siblingtaxaindigenous');" style="height:40px;resize:vertical;" ><?php echo array_key_exists('siblingtaxaindigenous',$occArr)?$occArr['siblingtaxaindigenous']:''; ?></textarea><?php
															if(!isset($SIBLINGTAXAINDIGENOUSLABEL) || $SIBLINGTAXAINDIGENOUSLABEL){
																echo '<a href="#" onclick="openSiblingSppAid();return false;"><img src="../../images/list.png" /></a>';
															}
															?>
														</div>
                            <div id="childTaxaIndigenousDiv">
                              <?php echo (defined('CHILDTAXAINDIGENOUSLABEL')?CHILDTAXAINDIGENOUSLABEL:'Child taxa'); ?>
                              <a href="#" onclick="return dwcDoc('childTaxaIndigenous')"><img class="docimg" src="../../images/qmark.png" /></a><br/>
                              <textarea name="childtaxaindigenous" id="childTaxaIndigenous" tabindex="135" onchange="fieldChanged('childtaxaindigenous');" style="height:40px;resize:vertical;" ><?php echo array_key_exists('childtaxaindigenous',$occArr)?$occArr['childtaxaindigenous']:''; ?></textarea>
															<?php
															if(!isset($CHILDTAXAINDIGENOUSLABEL) || $CHILDTAXAINDIGENOUSLABEL){
																echo '<a href="#" onclick="openChildSppAid();return false;"><img src="../../images/list.png" /></a>';
															}
															?>
														</div>
                            <div id="notesIndigenousDiv">
                              <?php echo (defined('NOTESINDIGENOUSLABEL')?NOTESINDIGENOUSLABEL:'Discussion'); ?>
                          ...
                          <fieldset>
                            <legend><b>Use Information</b></legend>
														...
														<div id="otherTaxaUseIndigenousDiv">
															...
															<!--<input type="text" name="othertaxauseindigenous" tabindex="140" maxlength="50" value="<?php echo array_key_exists('othertaxauseindigenous',$occArr)?$occArr['othertaxauseindigenous']:''; ?>" onchange="fieldChanged('othertaxauseindigenous');" />-->
														</div>
