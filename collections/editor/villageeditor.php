...
<head>
	...
	<title><?php echo $DEFAULT_TITLE; ?> Village Editor</title>
					...
					<table id="edittable" style="">
						<tr><td id="editortd" style="" valign="top">
							<div id="occedittabs" style="clear:both;">
									...
									<li>
										<a href="#occdiv"  style="">
											...
											if($occId){
												...
												echo '<span style="color:red;">New Village Record</span>';
											}
											?>
										</a>
									</li>
								...
								<div id="occdiv">
									<form id="fullform" name="fullform" action="villageeditor.php" method="post" onsubmit="return verifyFullForm(this);">
										<!-- CA: Bookmark -->
										<fieldset>
                        ...
                        <div class="clearfix">
                          <fieldset>
                            <legend><b>Village Information</b></legend>
														<div id="countryConsultantIndigenousDiv">
															<?php echo (defined('COUNTRYCONSULTANTINDIGENOUSLABEL')?COUNTRYCONSULTANTINDIGENOUSLABEL:'Country'); ?>
															<a href="#" onclick="return dwcDoc('countryConsultantIndigenous')"><img class="docimg" src="../../images/qmark.png" /></a><br/>
															<input type="text" name="countryconsultantindigenous" tabindex="124" maxlength="50" value="<?php echo array_key_exists('countryconsultantindigenous',$occArr)?$occArr['countryconsultantindigenous']:''; ?>" onchange="fieldChanged('countryconsultantindigenous');" />
														</div>
														<div id="stateConsultantIndigenousDiv">
															<?php echo (defined('STATECONSULTANTINDIGENOUSLABEL')?STATECONSULTANTINDIGENOUSLABEL:'State'); ?>
															<a href="#" onclick="return dwcDoc('stateConsultantIndigenous')"><img class="docimg" src="../../images/qmark.png" /></a><br/>
															<input type="text" name="stateconsultantindigenous" tabindex="125" maxlength="50" value="<?php echo array_key_exists('stateconsultantindigenous',$occArr)?$occArr['stateconsultantindigenous']:''; ?>" onchange="fieldChanged('stateconsultantindigenous');" />
														</div>
														<div id="municipalityConsultantIndigenousDiv">
															<?php echo (defined('MUNICIPALITYCONSULTANTINDIGENOUSLABEL')?MUNICIPALITYCONSULTANTINDIGENOUSLABEL:'Municipality'); ?>
															<a href="#" onclick="return dwcDoc('municipalityConsultantIndigenous')"><img class="docimg" src="../../images/qmark.png" /></a><br/>
															<input type="text" name="municipalityconsultantindigenous" tabindex="126" maxlength="50" value="<?php echo array_key_exists('municipalityconsultantindigenous',$occArr)?$occArr['municipalityconsultantindigenous']:''; ?>" onchange="fieldChanged('municipalityconsultantindigenous');" />
														</div>
