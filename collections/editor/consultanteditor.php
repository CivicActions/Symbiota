...
<head>
	...
	<title><?php echo $DEFAULT_TITLE; ?> Consultant Editor</title>
					...
					<table id="edittable" style="">
						<tr><td id="editortd" style="" valign="top">
							<div id="occedittabs" style="clear:both;">
									...
									<li>
										<a href="#occdiv"  style="">
											...
											if($occId){
												...
												echo '<span style="color:red;">New Consultant Record</span>';
											}
											?>
										</a>
									</li>
								...
								<div id="occdiv">
									<form id="fullform" name="fullform" action="consultanteditor.php" method="post" onsubmit="return verifyFullForm(this);">
										<!-- CA: Bookmark -->
										<fieldset>
                        ...
                        <div class="clearfix">
                          <fieldset>
                            ...
                            <div id="sexConsultantIndigenousDiv">
                              <?php echo (defined('SEXCONSULTANTINDIGENOUSLABEL')?SEXCONSULTANTINDIGENOUSLABEL:'Sex'); ?>
                              <a href="#" onclick="return dwcDoc('sexConsultantIndigenous')"><img class="docimg" src="../../images/qmark.png" /></a><br/>
                              <input type="text" name="sexconsultantindigenous" tabindex="122" maxlength="20" value="<?php echo array_key_exists('sexconsultantindigenous',$occArr)?$occArr['sexconsultantindigenous']:''; ?>" onchange="fieldChanged('sexconsultantindigenous');" />
                            </div>
                            <div id="dobConsultantIndigenousDiv">
                              <?php echo (defined('DOBCONSULTANTINDIGENOUSLABEL')?DOBCONSULTANTINDIGENOUSLABEL:'Year of birth'); ?>
                              <a href="#" onclick="return dwcDoc('dobConsultantIndigenous')"><img class="docimg" src="../../images/qmark.png" /></a><br/>
                              <input type="text" name="dobconsultantindigenous" tabindex="123" maxlength="50" value="<?php echo array_key_exists('dobconsultantindigenous',$occArr)?$occArr['dobconsultantindigenous']:''; ?>" onchange="fieldChanged('dobconsultantindigenous');" />
                            </div>
                            <div id="nameFirstConsultantIndigenousDiv">
                              <?php echo (defined('NAMEFIRSTCONSULTANTINDIGENOUSLABEL')?NAMEFIRSTCONSULTANTINDIGENOUSLABEL:'Consultant First Name'); ?>
                              <a href="#" onclick="return dwcDoc('nameFirstConsultantIndigenous')"><img class="docimg" src="../../images/qmark.png" /></a><br/>
                              <input type="text" name="namefirstconsultantindigenous" tabindex="124" maxlength="100" value="<?php echo array_key_exists('namefirstconsultantindigenous',$occArr)?$occArr['namefirstconsultantindigenous']:''; ?>" onchange="fieldChanged('namefirstconsultantindigenous');" />
                            </div>
                            <div id="nameLastConsultantIndigenousDiv">
                              <?php echo (defined('NAMELASTCONSULTANTINDIGENOUSLABEL')?NAMELASTCONSULTANTINDIGENOUSLABEL:'Consultant Last Name'); ?>
                              <a href="#" onclick="return dwcDoc('nameLastConsultantIndigenous')"><img class="docimg" src="../../images/qmark.png" /></a><br/>
                              <input type="text" name="namelastconsultantindigenous" tabindex="125" maxlength="100" value="<?php echo array_key_exists('namelastconsultantindigenous',$occArr)?$occArr['namelastconsultantindigenous']:''; ?>" onchange="fieldChanged('namelastconsultantindigenous');" />
                            </div>
														<div class="clearfix"></div>
														<div id="villageConsultantIndigenousDiv">
															<a  style="font-weight:bold;margin:10px;padding:5px 10px;border: #333 1px solid;text-decoration:none;float:right;" href="/collections/editor/villageeditor.php?gotomode=1&collid=1">Enter New Village Information</a>
															<?php echo (defined('VILLAGECONSULTANTINDIGENOUSLABEL')?VILLAGECONSULTANTINDIGENOUSLABEL:'Village'); ?>
															<a href="#" onclick="return dwcDoc('villageConsultantIndigenous')"><img class="docimg" src="../../images/qmark.png" /></a><br/>
															<input type="text" name="villageconsultantindigenous" tabindex="127" maxlength="50" value="<?php echo array_key_exists('villageconsultantindigenous',$occArr)?$occArr['villageconsultantindigenous']:''; ?>" onchange="fieldChanged('villageconsultantindigenous');" />
														</div>
														<div class="clearfix"></div>
