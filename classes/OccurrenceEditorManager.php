...
class OccurrenceEditorManager {
	...
	public function __construct($conn = null){
		...
		$this->occFieldArr = array('dbpk', 'catalognumber', 'othercatalognumbers', 'occurrenceid','family', 'scientificname', 'sciname',
			...
			'observeruid','basisofrecord','ownerinstitutioncode','datelastmodified', 'processingstatus', 'recordenteredby', 'dateentered', 'idconsultantindigenous', 'sexconsultantindigenous', 'dobconsultantindigenous', 'namefirstconsultantindigenous', 'namelastconsultantindigenous', 'linklanguageconsultantindigenous', 'familylanguageconsultantindigenous', 'grouplanguageconsultantindigenous', 'subgrouplanguageconsultantindigenous', 'villageconsultantindigenous', 'municipalityconsultantindigenous', 'stateconsultantindigenous', 'countryconsultantindigenous', 'isolanguageconsultantindigenous', 'vernacularlexiconindigenous', 'glosslexiconindigenous', 'parselexiconindigenous', 'parenttaxonindigenous', 'siblingtaxaindigenous', 'childtaxaindigenous', 'othertaxauseindigenous', 'typologylexiconindigenous', 'semanticslexiconindigenous', 'notesindigenous', 'categoryuseindigenous', 'specificuseindigenous', 'partuseindigenous', 'notesuseindigenous');
	...
	public function addOccurrence($occArr){
		...
		if($occArr){
			...
			$fieldArr = array('basisOfRecord' => 's', 'catalogNumber' => 's', 'otherCatalogNumbers' => 's', 'occurrenceid' => 's', 'ownerInstitutionCode' => 's', 
				...
				'processingstatus' => 's', 'recordEnteredBy' => 's', 'observeruid' => 'n', 'dateentered' => 'd', 'genericcolumn2' => 's', 'idConsultantIndigenous' => 's', 'sexConsultantIndigenous' => 's', 'dobConsultantIndigenous' => 'd', 'nameFirstConsultantIndigenous' => 's', 'nameLastConsultantIndigenous' => 's', 'linkLanguageConsultantIndigenous' => 's', 'familyLanguageConsultantIndigenous' => 's', 'groupLanguageConsultantIndigenous' => 's', 'subgroupLanguageConsultantIndigenous' => 's', 'villageConsultantIndigenous' => 's', 'municipalityConsultantIndigenous' => 's', 'stateConsultantIndigenous' => 's', 'countryConsultantIndigenous' => 's', 'isoLanguageConsultantIndigenous' => 's', 'vernacularLexiconIndigenous' => 's', 'glossLexiconIndigenous' => 's', 'parseLexiconIndigenous' => 's', 'parentTaxonIndigenous' => 's', 'siblingTaxaIndigenous' => 's', 'childTaxaIndigenous' => 's', 'otherTaxaUseIndigenous' => 's', 'typologyLexiconIndigenous' => 's', 'semanticsLexiconIndigenous' => 's', 'notesIndigenous' => 's', 'categoryUseIndigenous' => 's', 'specificUseIndigenous' => 's', 'partUseIndigenous' => 's', 'notesUseIndigenous' => 's');
